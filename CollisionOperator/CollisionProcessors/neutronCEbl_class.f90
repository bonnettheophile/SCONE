...
contains
  ...
  subroutine init(self, dict)
    ...
    character(100), parameter :: Here = 'init (neutronCEbls.f90)'
  ...
  subroutine sampleCollision(self, p, collDat, thisCycle, nextCycle)
    ...
    real(defReal)                        :: r
    character(100),parameter :: Here = 'sampleCollision (neutronCEbls.f90)'
  ...
  subroutine fission(self, p, collDat, thisCycle, nextCycle)
    ...
    character(100),parameter             :: Here = 'fission (neutronCEbls.f90)'
  ...
  subroutine elastic(self, p, collDat, thisCycle, nextCycle)
    ...
    character(100),parameter :: Here = 'elastic (neutronCEbls.f90)'
  ...
  subroutine inelastic(self, p, collDat, thisCycle, nextCycle)
    ...
    class(particleDungeon),intent(inout)   :: nextCycle
    class(uncorrelatedReactionCE), pointer :: reac
    character(100),parameter  :: Here =' inelastic (neutronCEbls.f90)'
  ...
  subroutine scatterFromMoving(self, p, collDat, reac)
    ...
    character(100), parameter :: Here = 'ScatterFromMoving (neutronCEbls.f90)'
